  ...
  return (
    <Flex minH='80vh' flexDir='column' w='90%'  justifyContent='center' className='home'>
      <svg width="102" height="102" viewBox="0 0 102 102" fill="none" xmlns="http://www.w3.org/2000/svg" className='pointer'>
        ...
        <path className='head' d="M98 1C97.0852 1.26014 95.9839 2.62329 95.1624 3.26042C93.3613 4.65728 91.6385 6.25271 90 8" stroke="#888" strokeWidth="2" strokeLinecap="round"/>
        <path className='head' d="M98 2C99.4265 4.88427 100.399 7.79676 101 11" stroke="#888" strokeWidth="2" strokeLinecap="round"/>
      </svg>
